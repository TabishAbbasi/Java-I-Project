...
/**
 * The controller for the AddProductForm.
 *
...
public class AddProductController {
    ...
    /**
     * Searches through all the products to determine if the
    ...
    /**
     * Produces a unique id for the product and populates the part tables.
     */
    @FXML
    public void initialize(){
        int uniqueProductId = Inventory.getAllProducts().size() + 1;
        if(!isIdAvailable(uniqueProductId)){
        ...
        idTextBox.setText(String.valueOf(uniqueProductId));
    ...
    /**
     * Creates a product and adds it to the product list in
     * the inventory.
     * <p>
